...
__decorate([
    (0, roles_decorator_1.Roles)('Admin', 'Manager'),
    (0, common_1.Patch)(':id/sip-credentials'),
    __param(0, (0, common_1.Param)('id')),
    __param(1, (0, common_1.Body)()),
    __param(2, (0, common_1.Req)()),
    __metadata("design:type", Function),
    ...
    __metadata("design:returntype", void 0)
], UsersController.prototype, "updateSipCredentials", null);
__decorate([
    (0, roles_decorator_1.Roles)('Admin', 'Manager'),
    (0, common_1.Patch)(':id/caller-number'),
    __param(0, (0, common_1.Param)('id')),
    __param(1, (0, common_1.Body)('callerNumber')),
    __param(2, (0, common_1.Req)()),
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [String, Object, Object]),
    __metadata("design:returntype", void 0)
], UsersController.prototype, "updateCallerNumber", null);
__decorate([
    (0, roles_decorator_1.Roles)('Admin', 'Manager'),
    (0, common_1.Put)(':id/lists'),
    __param(0, (0, common_1.Param)('id')),
    __param(1, (0, common_1.Body)('listIds')),
    __param(2, (0, common_1.Req)()),
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [String, Array, Object]),
    __metadata("design:returntype", void 0)
], UsersController.prototype, "updateAgentLists", null);
__decorate([
    (0, roles_decorator_1.Roles)('Admin'),
