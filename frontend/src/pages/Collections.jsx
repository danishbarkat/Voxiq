        ...
        <section style={{ padding: '80px 0', background: '#020D1A' }}>
          <div className="container" style={{ maxWidth: '1280px', margin: '0 auto', padding: '0 2rem' }}>
            <div style={{ textAlign: 'center', marginBottom: '60px' }}>
              <h2 style={{ fontSize: '2.25rem', fontWeight: 700, color: '#F1F5F9', letterSpacing: '-0.02em' }}>The old way of collection is broken</h2>
            </div>
            ...
            <div style={{ display: 'flex', flexDirection: 'column', gap: '80px' }}>
              ...
              <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: '60px', alignItems: 'center' }} className="feature-row">
                ...
                <div style={{
                  ...
                  <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', marginBottom: '16px' }}>
                    <span style={{ fontSize: '13px', fontWeight: 600, color: '#F1F5F9' }}>Outbound Dialer Queue</span>
                    <span style={{ color: '#7C6DFA', fontSize: '12px', fontWeight: 600 }}>Dialing 34/300</span>
                  </div>
                  <div style={{ background: '#020D1A', border: '1px solid #1e2537', borderRadius: '8px', padding: '16px' }}>
                    <div style={{ fontSize: '11px', color: '#6B9AB8', marginBottom: '4px' }}>Current Call</div>
                    <div style={{ fontSize: '16px', fontWeight: 700, color: '#F1F5F9' }}>Debtor Account #1203</div>
                    <div style={{ fontSize: '12px', color: '#6B9AB8', marginTop: '4px' }}>Result: No Answer → VM Drop triggered</div>
                  </div>
                </div>
              </div>
              ...
              <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: '60px', alignItems: 'center' }} className="feature-row">
                <div style={{
                  ...
                  <div style={{ display: 'flex', flexDirection: 'column', gap: '8px', background: '#020D1A', border: '1px solid #1e2537', borderRadius: '8px', padding: '12px' }}>
                    <span style={{ fontSize: '11px', color: '#6B9AB8' }}>Consolidated Debtor Inbox</span>
                    <div style={{ fontSize: '13px', fontWeight: 600, color: '#F1F5F9', marginTop: '6px' }}>Outgoing SMS:</div>
                    <div style={{ fontSize: '12px', fontStyle: 'italic', color: '#CBD5E1' }}>"We tried contacting you regarding account #1203. Click to view settlement options..."</div>
                  </div>
                </div>
                <div>
                  <h2 style={{ fontSize: '2.25rem', fontWeight: 700, color: '#F1F5F9', marginBottom: '20px', lineHeight: '1.2', letterSpacing: '-0.02em' }}>
        ...
        <section style={{ padding: '80px 0', background: '#020D1A' }}>
          <div className="container" style={{ maxWidth: '900px', margin: '0 auto', padding: '0 2rem' }}>
            <div style={{
              ...
              <div style={{ fontWeight: 600, color: '#F1F5F9', fontSize: '15px' }}>Operations Manager</div>
              <div style={{ color: '#6B9AB8', fontSize: '13px', marginTop: '4px' }}>Collections Agency</div>
