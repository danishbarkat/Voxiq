          ...
          <div style={{ display: 'grid', gridTemplateColumns: '1.1fr 0.9fr', gap: '60px', alignItems: 'center' }} className="hero-grid-solutions">
            ...
            <div style={{
              ...
              <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', marginBottom: '20px', borderBottom: '1px solid #1e2537', paddingBottom: '12px' }}>
                ...
                <span style={{ background: 'rgba(124, 109, 250, 0.1)', color: '#A594F9', padding: '3px 8px', borderRadius: '4px', fontSize: '11px', fontWeight: 600 }}>Active</span>
              </div>
              <div style={{ display: 'flex', flexDirection: 'column', gap: '12px' }}>
                <div style={{ display: 'flex', justifyContent: 'space-between', padding: '8px 12px', background: '#020D1A', border: '1px solid #1e2537', borderRadius: '6px', fontSize: '13px' }}>
                  ...
                  <span style={{ color: '#7C6DFA', fontWeight: 600 }}>200+</span>
                </div>
                <div style={{ display: 'flex', justifyContent: 'space-between', padding: '8px 12px', background: '#020D1A', border: '1px solid #1e2537', borderRadius: '6px', fontSize: '13px' }}>
        ...
        <section style={{ padding: '80px 0', background: '#020D1A' }}>
          <div className="container" style={{ maxWidth: '1280px', margin: '0 auto', padding: '0 2rem' }}>
            <div style={{ textAlign: 'center', marginBottom: '60px' }}>
              <h2 style={{ fontSize: '2.25rem', fontWeight: 700, color: '#F1F5F9', letterSpacing: '-0.02em' }}>The old way is costing you policy holders</h2>
            </div>
            ...
            <div style={{ display: 'flex', flexDirection: 'column', gap: '80px' }}>
              ...
              <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: '60px', alignItems: 'center' }} className="feature-row">
                ...
                <div style={{
                  ...
                  <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', marginBottom: '16px' }}>
                    <span style={{ fontSize: '13px', fontWeight: 600, color: '#F1F5F9' }}>Auto Renewal Campaign</span>
                    <span style={{ color: '#7C6DFA', fontSize: '12px', fontWeight: 600 }}>Active</span>
                  </div>
                  <div style={{ background: '#020D1A', border: '1px solid #1e2537', borderRadius: '8px', padding: '16px', marginBottom: '16px' }}>
                    <div style={{ fontSize: '11px', color: '#6B9AB8', textTransform: 'uppercase', marginBottom: '4px' }}>Current Batch</div>
                    <div style={{ fontSize: '15px', fontWeight: 700, color: '#F1F5F9' }}>Auto Renewals - July 2026</div>
                    <div style={{ fontSize: '12px', color: '#6B9AB8', marginTop: '4px' }}>342 policy holders loaded</div>
                  </div>
                  <div style={{ background: 'rgba(16, 185, 129, 0.05)', border: '1px solid rgba(16, 185, 129, 0.2)', padding: '12px', borderRadius: '8px' }}>
                    <div style={{ fontSize: '12px', color: '#10B981', fontWeight: 600 }}>Auto-SMS Sent:</div>
                    <div style={{ fontSize: '12px', color: '#CBD5E1', fontStyle: 'italic', marginTop: '4px' }}>"Hi John, your auto policy is expiring soon. Click to renew instantly..."</div>
                  </div>
                </div>
              </div>
              ...
              <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: '60px', alignItems: 'center' }} className="feature-row">
                <div style={{
                  ...
                  <div style={{ display: 'flex', alignItems: 'center', gap: '8px', marginBottom: '16px', color: '#10B981', fontSize: '13px', fontWeight: 600 }}>
                    <Lock size={16} /> TCPA Compliance Monitor
                  </div>
                  <div style={{ display: 'flex', flexDirection: 'column', gap: '8px' }}>
                    <div style={{ display: 'flex', justifyContent: 'space-between', background: '#020D1A', border: '1px solid #1e2537', padding: '10px 14px', borderRadius: '6px', fontSize: '13px' }}>
                      <span style={{ color: '#CBD5E1' }}>DNC Scrubbing</span>
                      <span style={{ color: '#10B981', fontWeight: 600 }}>Active</span>
                    </div>
                    <div style={{ display: 'flex', justifyContent: 'space-between', background: '#020D1A', border: '1px solid #1e2537', padding: '10px 14px', borderRadius: '6px', fontSize: '13px' }}>
                      <span style={{ color: '#CBD5E1' }}>Consent Logs</span>
                      <span style={{ color: '#10B981', fontWeight: 600 }}>Logged</span>
                    </div>
                    <div style={{ display: 'flex', justifyContent: 'space-between', background: '#020D1A', border: '1px solid #1e2537', padding: '10px 14px', borderRadius: '6px', fontSize: '13px' }}>
                      <span style={{ color: '#CBD5E1' }}>Calling Hours (by state)</span>
        ...
        <section style={{ padding: '80px 0', background: '#020D1A' }}>
          <div className="container" style={{ maxWidth: '900px', margin: '0 auto', padding: '0 2rem' }}>
            <div style={{
              ...
              <div style={{ fontWeight: 600, color: '#F1F5F9', fontSize: '15px' }}>Patricia M.</div>
              <div style={{ color: '#6B9AB8', fontSize: '13px', marginTop: '4px' }}>Agency Owner, Phoenix AZ</div>
