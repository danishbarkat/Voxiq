            ...
            <div style={{ display: 'flex', flexDirection: 'column', gap: '80px' }}>
              ...
              <div style={{
                ...
                <div>
                  ...
                  <ul style={{ listStyle: 'none', padding: 0, margin: 0, display: 'flex', flexDirection: 'column', gap: '12px' }}>
                    <li style={{ display: 'flex', alignItems: 'center', gap: '8px', fontSize: '0.95rem', fontWeight: 600 }}><CheckCircle2 size={16} color="#7C6DFA" /> Call volume levels</li>
                    <li style={{ display: 'flex', alignItems: 'center', gap: '8px', fontSize: '0.95rem', fontWeight: 600 }}><CheckCircle2 size={16} color="#7C6DFA" /> Connect rate percentage</li>
                    <li style={{ display: 'flex', alignItems: 'center', gap: '8px', fontSize: '0.95rem', fontWeight: 600 }}><CheckCircle2 size={16} color="#7C6DFA" /> Average talk time s</li>
                    <li style={{ display: 'flex', alignItems: 'center', gap: '8px', fontSize: '0.95rem', fontWeight: 600 }}><CheckCircle2 size={16} color="#7C6DFA" /> Outcome rate values</li>
                    <li style={{ display: 'flex', alignItems: 'center', gap: '8px', fontSize: '0.95rem', fontWeight: 600 }}><CheckCircle2 size={16} color="#7C6DFA" /> Pipeline created deals</li>
                  </ul>
                </div>
                <div style={{
                  background: '#0F0F1A',
                  ...
                  <h4 style={{ margin: '0 0 12px 0', fontSize: '0.9rem', color: '#A594F9' }}>5 Core Metrics Panel</h4>
              ...
              <div style={{
                ...
                <div style={{
                  ...
                  <h4 style={{ margin: '0 0 12px 0', fontSize: '0.9rem', color: '#A594F9' }}>Automated Reports Console</h4>
